...
<body>
	<div class="login-form">
		<h1>Sign In</h1>
			<h2><a href="<?php echo base_url();?>page_ctr/user_reg">Create Account</a></h2>
				<form action="<?php echo base_url();?>login_ctr/masuk" method="post">
					<li>
						<input name="username" type="text" class="text" value="User Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" ><a href="#" class=" icon user"></a>
					</li>
					<li>
