...
class Jadwal_ctr extends CI_Controller
	{
		...
		public function lihat_lap(){
			...
			foreach ($data as $item) {
				...
				echo					'<td>'.$waktu[5].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=12.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[5].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>7</td>';
				echo					'<td>'.$waktu[6].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=13.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[6].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>8</td>';
				echo					'<td>'.$waktu[7].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=14.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[7].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>9</td>';
				echo					'<td>'.$waktu[8].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=15.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[8].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>10</td>';
				echo					'<td>'.$waktu[9].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=16.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[9].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>11</td>';
				echo					'<td>'.$waktu[10].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=17.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[10].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>12</td>';
				echo					'<td>'.$waktu[11].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=18.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[11].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>13</td>';
				echo					'<td>'.$waktu[12].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=19.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[12].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>14</td>';
				echo					'<td>'.$waktu[13].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=20.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[13].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>15</td>';
				echo					'<td>'.$waktu[14].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=21.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[14].'> Booking </button></a></td>';
				echo				'</tr>';
				echo				'<tr>';
				echo					'<td>16</td>';
				echo					'<td>'.$waktu[15].'</td>';
				echo					'<td>Booked by Komsi</td>';
				echo					'<td><a href="pesan?id_lap='.$item['id_lap'].'&&id_futsal='.$item['id_futsal'].'&&jam=22.00&&tgl='.$tgl.'"><button class="btn btn-success" '.$button[15].'> Booking </button></a></td>';
				echo				'</tr>';
				echo		'</tbody>';
				echo	'</table>';
				echo '</p>';
